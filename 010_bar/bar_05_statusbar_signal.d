...
{
    Separator separatorV1, separatorV2;
    Label directionLabel, contextLabel;
    ...
    this()
    {
        ...
        packStart( separatorV2, false, false, padding );
        separatorV2.setMarginLeft( marginWidth );
        separatorV2.setMarginRight( marginWidth );

        contextLabel = new Label( "Context ID: " );
        contextLabel.setSizeRequest( labelWidth, labelHeight );
        packStart( contextLabel, false, false, padding );
