...
{
    string title = "Notebook - Change Tab Text";
    AppBox appBox;
...
class ButtonGrid : Grid
{
    ...
    SetTabTextButton setTabTextButton;
    ...
    this( MyNotebook myNotebook )
    {
        ...
        setTabTextButton = new SetTabTextButton( myNotebook );
        attach( setTabTextButton, 3, 0, 1, 1 );
...
class SetTabTextButton : Button
{
    string _buttonLabel = "Change Tab Text";
